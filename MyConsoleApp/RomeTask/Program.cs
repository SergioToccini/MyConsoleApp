...
namespace RomeTask
{
    class Program
    {
        ...
        а возвращает это число в арабском виде. Например, если передаём "XV" - должна вернуть 15, если передаём "IV" - должна вернуть 4.
        ...
        Хотя Римляне и пользовались иногда такими видами записей, но есть разная информация о приемлимости оных. 
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Римская цифра '{example9}' равна арабской {converter.Convert(example9)}");
            Console.WriteLine($"Римская цифра '{example99}' равна арабской {converter.Convert(example99)}");
            Console.WriteLine($"Римская цифра '{example49}' равна арабской {converter.Convert(example49)}");
            Console.ReadKey();
        }
    }
}
